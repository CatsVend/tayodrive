  ...
  <div className="max-w-5xl mx-auto glass-neon p-10 md:p-14 rounded-3xl shadow-xl border program-card fade-in">
    <div className="flex flex-col md:flex-row gap-10 items-center">
      <div className="flex-1 flex flex-col gap-3 items-start">
        ...
        {/* 제목 살짝 확대 */}
        <h2 className="text-3xl md:text-3xl font-extrabold text-blue-700 mb-3">
          핵심만 빠르게, 실전·주차·고속주행 집중
        </h2>

        {/* 본문: 크기 확대 + 왼쪽 정렬 + 들여쓰기 제거 */}
        <ul className="text-gray-800 text-base space-y-1 mb-4">
          <li>1일차: 차량 조작 기본, 운전자세, 출발·제동, 좌/우회전</li>
          <li>2일차: 도로·고속주행, 차선변경, 방어운전, 교차로 통행</li>
          <li>3일차: 시내·이면도로 주행, 주차 실습(전진/후진/T/평행)</li>
        </ul>
  ...
  <div className="max-w-5xl mx-auto glass-neon p-10 md:p-14 rounded-3xl shadow-xl border program-card fade-in">
    <div className="flex flex-col md:flex-row gap-10 items-center">
      <div className="flex-1 flex flex-col gap-3 items-start">
        ...
        >
                  4일반 연수</span>
                <h2 className="text-3xl font-extrabold text-blue-700 mb-2">운전 기초부터 주차까지, 완벽 마스터</h2>
                <ul className="text-gray-800 text-base space-y-1 mb-4">
                  <li>1일차: 차량 조작 이론, 안전주행, 기본 운전자세</li>
                  <li>2일차: 도로주행, 고속주행, 표지판·신호등·차간거리</li>
                  <li>3일차: 심화주행(이면도로, 신호 없는 교차로 등)</li>
                  <li>4일차: 주차이론+실전, 전진·후진·평행·T주차</li>
                </ul>
                <div className="flex flex-wrap gap-2 text-cyan-700 font-bold text-sm">
                  <span>#초보탈출</span>
                  <span>#방문연수</span>
              ...
              <div className="flex-1 flex flex-col gap-3 items-center">
                <img
                  src="/images/course03.webp"
                  alt="운전 실습 이미지"
                  className="w-52 md:w-60 rounded-2xl img-glow mb-2 fade-in"
                />
                <img
                  src="/images/course04.webp"
                  alt="차량 주차 연습"
                  className="w-40 rounded-xl img-glow border border-blue-200 md:block hidden fade-in"
                  style={{ animationDelay: ".2s" }}
                />
